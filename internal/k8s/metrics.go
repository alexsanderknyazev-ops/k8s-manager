...
func GetPodMetrics(metricsClient metricsv.Interface, clientset kubernetes.Interface, namespace string) ([]PodMetrics, error) {
...
func GetSinglePodMetrics(metricsClient metricsv.Interface, clientset kubernetes.Interface, namespace, podName string) (*metricsv1beta1.PodMetrics, *corev1.Pod, error) {
...
func GetNodeMetrics(metricsClient metricsv.Interface, clientset kubernetes.Interface) ([]NodeMetrics, *ClusterMetrics, error) {
...
func GetAllPodsMetrics(metricsClient metricsv.Interface, clientset kubernetes.Interface) ([]map[string]interface{}, int64, int64, error) {
